...
public class FireflaskthrowableItem extends Item {
	public FireflaskthrowableItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				FireflaskthrowableEntity entityarrow = FireflaskthrowableEntity.shoot(world, entity, world.getRandom(), 0.1f, 5, 1);
