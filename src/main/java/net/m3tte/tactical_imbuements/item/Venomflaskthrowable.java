...
public class Venomflaskthrowable extends Item {
	public Venomflaskthrowable() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				VenomFlaskThrowableEntity entityarrow = VenomFlaskThrowableEntity.shoot(world, entity, world.getRandom(), 0.1f, 5, 1);
