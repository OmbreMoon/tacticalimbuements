...
public class EmptyflaskthrowableItem extends Item {
	public EmptyflaskthrowableItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				EmptyflaskthrowableEntity entityarrow = EmptyflaskthrowableEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
